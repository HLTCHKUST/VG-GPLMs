...
class BartEncoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None,
                 fusion_layer=None, use_img_trans=None, use_forget_gate=None, cross_attn_type=None, dim_common=256, n_attn_heads=1, fusion_in_decoding=None):
        ...
        # ==================== Modification Starts ====================
        self.fusion_in_decoding = fusion_in_decoding
        self.fusion_layer = fusion_layer
        self.use_forget_gate = use_forget_gate
        self.use_img_trans = use_img_trans
        self.cross_attn_type = cross_attn_type
        if not self.fusion_in_decoding:
...
class BartDecoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None,
        ...
        if self.fusion_in_decoding:
            ...
            self.final_layer_norm = nn.LayerNorm(text_feature_dim)
            self.sigmiod = nn.Sigmoid()
        # ==================== Modification Ends ====================
...
class BartModel(BartPretrainedModel):
    def __init__(self, config: BartConfig,
        ...
        self.encoder = BartEncoder(config, self.shared,
                                   fusion_layer, use_img_trans, use_forget_gate, cross_attn_type, dim_common, n_attn_heads, fusion_in_decoding)
...
class BartForMultiModalGeneration(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, fusion_layer=None, use_img_trans=None, use_forget_gate=None, cross_attn_type=None, dim_common=256, n_attn_heads=1, fusion_in_decoding=None):
        super().__init__(config)
        self.model = BartModel(config, fusion_layer, use_img_trans, use_forget_gate, cross_attn_type, dim_common, n_attn_heads, fusion_in_decoding)
